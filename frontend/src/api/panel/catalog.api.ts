...
export type Product = { id: number; category_id: number; name: string; product_type: 'POTE'|'UNIT'; pote_size: 'KG_1'|'KG_HALF'|'KG_QUARTER'|null; min_flavors: number|null; max_flavors: number|null; price: string; is_active: boolean; image_url?: string|null }
