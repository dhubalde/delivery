  ...
  <v-container>
    ...
    <template v-else>
      <div class="d-flex align-center flex-nowrap px-4 py-1 text-caption text-medium-emphasis" style="flex-wrap:nowrap">
        <span style="flex:1; min-width:0" class="text-truncate">Nombre — Tipo — Precio</span>
