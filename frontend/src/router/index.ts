...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/panel', component: () => import('@/layouts/AdminLayout.vue'), meta: { requiresAuth: true }, children: [{ path: 'board', component: () => import('@/views/KanbanBoardView.vue') }, { path: 'categories', component: () => import('@/views/admin/AdminCategoriesView.vue') }, { path: 'products', component: () => import('@/views/admin/AdminProductsView.vue') }, { path: 'flavors', component: () => import('@/views/admin/AdminFlavorsView.vue') }, { path: 'catalog', redirect: '/panel/categories' }] },
